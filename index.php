...
<head>
  ...
  <script>
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-MP5K45DH');
  </script>
...
<body class="font-poppins text-slate-700 overflow-x-hidden">
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MP5K45DH"
        ...
        <div class="grid place-items-center">
          <a href="<?= $domain ?>">
            <img
              ...
              class="w-20 md:w-28 m-auto rounded-full"
              alt="logo" />
          </a>
        </div>
  ...
  <main class="overflow-x-hidden">
    ...
    <section class="container">
      <div
        ...
        <div
          class="absolute rounded-lg inset-0 bg-[radial-gradient(rgb(0_0_0_/_0.30),rgb(0_0_0_/_0.66))] from-0% via-50% to-100%">
        </div>
        <div
          ...
          <div class="col-span-full md:!col-span-1  ">
            <div class="text inner-container">
              ...
              <p class="desc !text-slate-300 !mb-5">
                <?= $desc ?> Fokus pada rute <a href="https://jasatravel.web.id/rute-travel/dari-dki-jakarta/ke-cianjur/31/320301" class="underline" target="_blank">Travel Jakarta Cianjur</a> murah, via tol, 24 jam, dan bonus makan sekali. Kami hadir sebagai solusi transportasi anda dengan ebebrapa layanan yang akan membantu anda seperti:
              </p>
          ...
          <div
            ...
            <?php if (count($galeri) > 0) : ?>
              <?php foreach ($galeri as $key => $item) : ?>
                <img
                  onclick="window.open('<?= $domain . 'src/img/galeri/default/' . $item ?>', '_blank')"
                  width="100"
                  height="100"
                  loading="lazy"
                  src="<?= $domain . 'src/img/galeri/default/' . $item ?>"
                  class="<?php
                          if ($key == 0 || $key == 3) {
                            echo 'sm:!col-span-8';
                          } elseif ($key == 1 || $key == 2) {
